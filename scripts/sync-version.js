...
// Read plugin file
const pluginPath = path.join(__dirname, '..', 'gform-booking.php');
...
// Update GFORM_BOOKING_VERSION constant
pluginContent = pluginContent.replace(
    /define\(\s*'GFORM_BOOKING_VERSION',\s*'[^']*'\s*\);/, 
    `define('GFORM_BOOKING_VERSION', '${version}');`
);

// Write updated plugin file
fs.writeFileSync(pluginPath, pluginContent);
console.log(`✅ Updated gform-booking.php`);

// Update README.md stable tag if exists
